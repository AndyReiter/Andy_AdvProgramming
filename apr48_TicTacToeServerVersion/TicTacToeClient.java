    ...
    {
        private JTextField idField; // textfield to display player's mar
        private JTextArea displayArea; // JTextArea to display output
        private JPanel boardPanel; // panel for tic-tac-toe board
        private JPanel panel2; // panel to hold board
        private JButton mnuNewGame;
        ...
        static boolean dontSetUpServer = false;
       ...
       public TicTacToeClient( String host )
       {
           ...
           mnuNewGame = new JButton("New Game");
           endGame = new JButton("End and Disconnect");
           boardPanel = new JPanel(); // set up panel for squares in board
           boardPanel.setLayout( new GridLayout( 3, 3, 0, 0 ) );
           board = new Square[ 3 ][ 3 ]; // create board
           mnuNewGame.setBounds(25, 25, 25, 25);
           endGame.setBounds(50, 50, 50, 50);
          // loop over the rows in the board
           ...
           panel2.add(mnuNewGame);
           panel2.add(endGame);
           setVisible( true ); // show window
           
           startClient();
           
           dontSetUpServer = true;
           TicTacToeServer andyObj = new TicTacToeServer();
           ...
           endGame.addActionListener(new ActionListener(){
               public void actionPerformed(ActionEvent e){
                   System.out.println("Here in End");
                   try
                   {
                       connection.close();
                       System.exit(0);
        ...
        {
            panel2.setLayout(new GridLayout(2, 1, 2, 5));
            boardPanel = new JPanel(); // set up panel for squares in board
            boardPanel.setLayout( new GridLayout( 3, 3, 0, 0 ) );
            panel2.add( boardPanel, BorderLayout.CENTER ); // add board panel
            add( panel2, BorderLayout.CENTER ); // add container panel
